  ...
  return (
    <section className="contact">
      ...
      <div className="contact__details">
        <a
          href="https://github.com/alancashman"
          className="contact__detail contact__detail--link"
        >
          <img src={githubIcon} alt="github" className="contact__icon" />
        </a>
        <a
          href="https://www.linkedin.com/in/alan-cashman/"
          className="contact__detail contact__detail--link"
        >
          <img src={linkedInIcon} alt="linkedin" className="contact__icon" />
        </a>
        <a
          href="mailto:alanvcashman@gmail.com"
          className="contact__detail contact__detail--email"
        >
          alanvcashman@gmail.com
        </a>
      </div>
    </section>
  );
